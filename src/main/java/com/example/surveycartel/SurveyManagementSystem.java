...
public class SurveyManagementSystem{// implements CommandLineRunner{
...
//		mail.setMailContent("Testing Successfull, fuck and enjoy");
		...
		SpringApplication.run(SurveyManagementSystem.class, args);
//		ApplicationContext ctx = SpringApplication.run(SurveyManagementSystem.class, args);
